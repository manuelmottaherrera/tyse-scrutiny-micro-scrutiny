...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.tyse.scrutiny.micro.scrutiny.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.tyse.scrutiny.micro.scrutiny.security.DomainUserDetailsService", "createSpringSecurityUser");
